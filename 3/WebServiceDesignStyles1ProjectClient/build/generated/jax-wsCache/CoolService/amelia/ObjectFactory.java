 ...
 * generated in the amelia package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetListAsXMLResponse_QNAME = new QName("http://Amelia/", "getListAsXMLResponse");
    private final static QName _GetSpyResponse_QNAME = new QName("http://Amelia/", "getSpyResponse");
    private final static QName _AddSpy_QNAME = new QName("http://Amelia/", "addSpy");
    private final static QName _GetSpy_QNAME = new QName("http://Amelia/", "getSpy");
    private final static QName _DeleteSpy_QNAME = new QName("http://Amelia/", "deleteSpy");
    private final static QName _DeleteSpyResponse_QNAME = new QName("http://Amelia/", "deleteSpyResponse");
    private final static QName _UpdateSpyResponse_QNAME = new QName("http://Amelia/", "updateSpyResponse");
    private final static QName _UpdateSpy_QNAME = new QName("http://Amelia/", "updateSpy");
    private final static QName _AddSpyResponse_QNAME = new QName("http://Amelia/", "addSpyResponse");
    private final static QName _GetListAsXML_QNAME = new QName("http://Amelia/", "getListAsXML");
    private final static QName _GetList_QNAME = new QName("http://Amelia/", "getList");
    private final static QName _GetListResponse_QNAME = new QName("http://Amelia/", "getListResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: amelia
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getListAsXMLResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getSpyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "addSpy")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getSpy")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "deleteSpy")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "deleteSpyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "updateSpyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "updateSpy")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "addSpyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getListAsXML")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Amelia/", name = "getListResponse")
